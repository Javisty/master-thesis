...
\thesistitle{Model-free Hierarchical Reinforcement Learning in Average-reward Markov Decision Processes} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
